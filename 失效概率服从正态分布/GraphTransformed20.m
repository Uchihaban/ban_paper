...
G3=triu(G);
x=unifrnd (5,150,21,21); %随机附上带宽，带宽满足（5,150）
B0=30;
...
ST2FULL=full(ST2);
%把T2中断掉的边连上
ST2FULL(19,6)=ST1FULL(19,6);
ST2FULL(6,1)=ST1FULL(6,1);
ST2FULL(19,2)=ST1FULL(19,2);
ST2FULL(14,3)=ST1FULL(14,3);
ST2FULL(11,4)=ST1FULL(11,4);
ST2FULL(15,5)=ST1FULL(15,5);
ST2FULL(18,12)=ST1FULL(18,12);
ST2FULL(19,12)=ST1FULL(19,12);

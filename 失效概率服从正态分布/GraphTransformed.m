...
G3=triu(G);
x=unifrnd (5,150,10,10); %随机附上带宽，带宽满足（5,150）
B0=30;
...
ST2FULL=full(ST2);
 ST2FULL(10,2)=ST1FULL(10,2);%把T2中断掉的边连上
 ST2FULL(4,1)=ST1FULL(4,1);
 ST2FULL(7,4)=ST1FULL(7,4);
 ST2FULL(8,5)=ST1FULL(8,5);
%  
%  ST2FULL(5,4)=ST1FULL(5,4);
%  ST2FULL(10,6)=B(10,6);
%  ST2FULL(10,9)=ST1FULL(10,9);


% ST2FULL(7,2)=ST1FULL(7,2);
% ST2FULL(10,1)=ST1FULL(10,1);

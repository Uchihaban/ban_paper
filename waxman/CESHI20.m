...
T1FULL(8,5)=0; %边属于T1,T1FULL为tree1断边后的邻接下三角矩阵
 view(biograph(T1FULL,[],'ShowArrows','off','ShowWeights','on')) ;
T2FULL(8,5)=0; %边属于T2,T2FULL为tree2断边后的邻接下三角矩阵

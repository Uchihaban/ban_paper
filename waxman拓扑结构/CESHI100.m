...
T1FULL(99,88)=0; %边属于T1,T1FULL为tree1断边后的邻接下三角矩阵
 view(biograph(T1FULL,[],'ShowArrows','off','ShowWeights','on')) ;
T2FULL(99,88)=0; %边属于T2,T2FULL为tree2断边后的邻接下三角矩阵
...
T1v1=[19,29,64,57,47,74,22,88,63,43,91,81,21,83,85,67];
v=(1:100);
